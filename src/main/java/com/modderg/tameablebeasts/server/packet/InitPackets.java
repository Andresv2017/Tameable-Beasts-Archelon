...
import com.modderg.tameablebeasts.client.packet.*;
...
public class InitPackets {
    ...
    public static void register(){
        ...
        INSTANCE.messageBuilder(StoCSyncFlying.class, id++)
                ...
                .add();
        INSTANCE.messageBuilder(StoCSyncSwimming.class, id++)
                .encoder(StoCSyncSwimming::encode)
                .decoder(StoCSyncSwimming::new)
                .consumerMainThread(StoCSyncSwimming::handle)
                .add();
        ...
        INSTANCE.messageBuilder(CtoSSyncRiderWantsSwimming.class, id++)
                .encoder(CtoSSyncRiderWantsSwimming::encode)
                .decoder(CtoSSyncRiderWantsSwimming::new)
                .consumerMainThread(CtoSSyncRiderWantsSwimming::handle)
                .add();
